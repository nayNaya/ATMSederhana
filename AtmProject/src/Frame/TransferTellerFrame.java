...
public class TransferTellerFrame extends FrameDasar {

    private Nasabah nasabah_tujuan;
    
    public TransferTellerFrame(Nasabah nasabah_tujuan , Nasabah nasabah) {
        super(nasabah);
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Broadway", 1, 30)); // NOI18N
        jLabel1.setText("TRANSFER TELLER PAGE ");
        ...
        jPanel1.setBackground(new java.awt.Color(60, 198, 193));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(28, 28, 28)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(akun_tf)
                            .addComponent(uang_tf)))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(rekening_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       this.getTellerControll().transfer(nasabah_tujuan,Integer.parseInt(uang_tf.getText()));
       this.changeFrame(new MenuTellerFrame(this.getNasabah()));
